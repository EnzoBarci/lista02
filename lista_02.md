...
```
Algoritmo Idade
    Var idade menor que 16, idade maior ou igual a 16 e menor que 18
Início
        Mostre um prompt com 'Insira sua idade' = Idade
    Se Idade <= 15 Entao
        Escreva "Não pode votar!"
    Senao
        idade maior ou igual a 16
    Se Idade >= 16 e < 18 Entao
...
Classe Retangulo extendida de FormaGeometrica
    Atributos:
        - cor = vermelho
        - base = 8
        - altura = 4
    ...
    Método Construtor (cor)
        Escreva "A cor do retângulo é: cor"
    Método CalcularArea(base * altura / 2)
        Escreva "A área do retângulo é: CalcularArea"

Classe Circulo extendida de FormaGeometrica
    Atributos:
        - cor = azul
        - raio = 3
        - π = 3,14
    ...
    Método Construtor (cor)
        Escreva "A cor do círculo é: cor"
    Método CalcularArea(π * raio²)
        Escreva "A área do círculo é: CalcularArea"
Fim.
````
...
```
Inicio
Função tempo_para_completar_distancia(distancia, velocidade_inicial, aceleracao, velocidade_maxima, tempo_maximo):
    tempo = 0
    velocidade = velocidade_inicial
    
    Enquanto verdadeiro:
        velocidade = velocidade + aceleracao
        velocidade = mínimo(velocidade, velocidade_maxima)
        
        dist_percorrida = velocidade_inicial * tempo + 0.5 * aceleracao * tempo * tempo
        
        Se dist_percorrida >= distancia:
            retornar tempo
